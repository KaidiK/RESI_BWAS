---
title: "Figure S7 - Resampling & the effect on WMV in ABCD"
author: "Kaidi Kang"
date: "2023-05-01"
...
## Fig S7. Resampling & the effect on WMV in ABCD
...
for (i in 1:length(var_cs)){
  ...
  psycho_obj$WMV$psycho_var = var_cs_lab[i]
  plot_data = rbind(plot_data, psycho_obj$WMV)
}
...
for (i in 1:length(var_long)){
  ...
  psycho_obj$WMV$psycho_var = var_long_lab[i]
  plot_data = rbind(plot_data, psycho_obj$WMV)
}
