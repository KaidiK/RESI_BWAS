---
title: "Figure S6 - Resampling & the effect on sGMV in ABCD"
author: "Kaidi Kang"
date: "2023-05-01"
...
## Fig S6. Resampling & the effect on sGMV in ABCD
...
for (i in 1:length(var_cs)){
  ...
  psycho_obj$sGMV$psycho_var = var_cs_lab[i]
  plot_data = rbind(plot_data, psycho_obj$sGMV)
}
...
for (i in 1:length(var_long)){
  ...
  psycho_obj$sGMV$psycho_var = var_long_lab[i]
  plot_data = rbind(plot_data, psycho_obj$sGMV)
}
